...
tags: [medio, mybb, cms, credentials leaking, brute force, rce, sudo]
...
Para la versión de **Mybb** instalada en la máquina (1.8.35), encontramos que es vulnerable a un **RCE** (Remote Code Execution), tal y como indica el siguiente [reporte](https://pentest-tools.com/vulnerabilities-exploits/mybb-1836-rce-vulnerability_20082):
